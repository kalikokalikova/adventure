  ...
  return (
    <div>
        <div className=' flex justify-between w-[100%] bg-[#69a1ac] text-white'>
            ...
            <div className={!nav ?  'fixed left-[-100%]'  : 'fixed left-0 top-0 w-[60%] h-full bg-[white] text-black ease-in-out duration-500'}>
            ...
            <ul className='flex flex-col justify-start items-center w-[100%] font-poppins px-4'>
                ...
                <li className='p-4 border-b-2 border-gray-200 w-[100%] hover:text-[#69a1ac] hover:scale-105 hover:duration-300 hover:ease-in-out'><Link to="">Contact</Link></li>
