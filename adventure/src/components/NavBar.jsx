    ...
    <div>
        <div className=' flex justify-between w-[100%] bg-[#69a1ac] text-white'>
            ...
            <ul className='hidden md:flex justify-around items-center w-[60%] font-poppins '>
                ...
                <li>
                    <button className='bg-[#ffd25a] hover:bg-[#ffd35adc] hover:ease-in-out hover:duration-300 active:shadow-inner-md text-black w-[100%] px-[1rem] py-1 rounded-lg shadow-lg'>
